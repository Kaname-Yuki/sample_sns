...
import 'package:sample_sns/pages/mypage.dart';
import 'package:sample_sns/pages/settings.dart';
import 'package:sample_sns/providers/common_parts.dart';
import 'package:sample_sns/pages/change_name.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/settings/change_username': (context) => const ChangeNamePage(),
      },
